"""
    ...
    1-open file
        fileobject=open(filename, mode of openinng)
            mode --> r ==> read
            w===> write 0---> when you open file with write mode> if the file doesn't exist
            python will try to create it ?
            if file exists > python open file for writing starting from the beginning of file
            --->remove old content
            a ===> append
            when you open file with append mode> if the file doesn't exist
            python will try to create it ?
            if file exists > python open file for writing starting from the end of file
            --->keep old content
    2- decide operation
